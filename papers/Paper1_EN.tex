...
\author{L. Geiger}
\email{lukas@geiger-research.de}
...
\item \textbf{Parameter freedom:} Four effective parameters versus two in $\Lambda$CDM lead to a marginal BIC disadvantage ($\Delta\mathrm{BIC} = +2.6$), which is however mitigated by the comparable cross-validation performance (see item~1 in Strengths above) and the robustness across different functional forms.
