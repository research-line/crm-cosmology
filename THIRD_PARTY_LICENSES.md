...
## 3. Observational Datasets (Attribution & Citation)
...
4. **Unprivileged Non-Elevation**: All tools run under standard unprivileged user accounts (`RunAsInvoker`) without requiring administrative or root elevation.
